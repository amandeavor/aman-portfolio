...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-paper dark:bg-[#111111] px-6 select-none">
      <div className="mx-auto max-w-6xl text-left">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
          {/* Left Column: Let's talk & Social Links */}
          <div className="md:col-span-6 flex flex-col justify-between h-full min-h-[380px]">
            <div>
          ...
          <div className="md:col-span-6 w-full bg-[#1f1f1f] dark:bg-[#FAF7F3] p-8 rounded-[24px] shadow-lg border border-zinc-800/50 dark:border-zinc-200/60 relative overflow-hidden">
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="name" className="text-[13px] font-bold text-zinc-100 dark:text-zinc-800 font-sans">
                    Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#2b2b2b] dark:bg-white text-zinc-100 dark:text-zinc-900 rounded-xl px-4 py-3.5 text-sm transition-all focus:outline-none placeholder-zinc-400 dark:placeholder-zinc-400 font-sans border border-zinc-800 dark:border-zinc-300 focus:border-zinc-700 dark:focus:border-zinc-400"
                ...
                {/* Email */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-[13px] font-bold text-zinc-100 dark:text-zinc-800 font-sans">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                {/* Message */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="message" className="text-[13px] font-bold text-zinc-100 dark:text-zinc-800 font-sans">
                    Your Project
                  </label>
                  <textarea
                    id="message"
                    ...
                    className="w-full bg-[#2b2b2b] dark:bg-white text-zinc-100 dark:text-zinc-900 rounded-xl px-4 py-3.5 text-sm transition-all focus:outline-none placeholder-zinc-400 dark:placeholder-zinc-400 min-h-[140px] max-h-[260px] resize-y font-sans border border-zinc-800 dark:border-zinc-300 focus:border-zinc-700 dark:focus:border-zinc-400"
