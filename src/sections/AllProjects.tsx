...
export function AllProjects() {
  ...
  return (
    <section aria-labelledby="all-projects-title" className="py-20 select-none bg-paper dark:bg-[#111111] text-offblack dark:text-zinc-200 text-left">
      <div className="mx-auto max-w-5xl px-4 min-[360px]:px-6">
        ...
        {/* Header */}
        <h1 id="all-projects-title" className="text-5xl sm:text-6xl md:text-7xl font-semibold tracking-normal text-offblack dark:text-zinc-100 leading-[0.95] font-display mb-6">
          My Brightest<br />Creations
        </h1>
        <p className="text-zinc-600 dark:text-zinc-400 text-sm sm:text-base leading-[1.65] mb-16 max-w-[55ch] font-sans">
          ...
          {PROJECTS_LIST.map((project, idx) => (
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between w-full mt-1 px-1 gap-2 select-none">
                <h3 className="text-xl md:text-2xl font-bold text-offblack dark:text-zinc-100 font-display tracking-normal group-hover:opacity-60 transition-opacity">
                  {project.title}
                </h3>
